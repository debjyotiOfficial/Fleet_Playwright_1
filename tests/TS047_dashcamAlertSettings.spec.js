...
test.describe('Dashcam Alert Settings', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('edit settings for dashcam', async ({ page }) => {
        ...
        const allAlertsCheckbox = page.locator(config.selectors.dashcam.allAlerts);
        ...
        await expect(page.locator(config.selectors.alertsContact.addEmailButton)).toBeVisible();
        await page.locator(config.selectors.alertsContact.addEmailButton).click();
